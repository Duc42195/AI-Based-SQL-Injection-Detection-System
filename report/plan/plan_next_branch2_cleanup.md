...
## Audit Branch 1 (theo yêu cầu mentor: "làm tiếp audit nhánh 1")

> Đọc kỹ: `report/metrics/audit_branch1/audit_report.md` | findings: `report/metrics/audit_branch1/findings.json`
> Script: `train/audit_branch1_data_validity.py` (`uv run python train/audit_branch1_data_validity.py`)

| Mảng | Kết quả |
|---|---|
| Mảng 1 — Phân phối | ✅ 5 lớp cân bằng (15,000/15,000/7,796/15,000/15,000), không phantom `stacked` |
| Mảng 2 — Duplicate cross-split | ❌ 4,277 extra copies; **949 text trùng ở cả train & test** (leakage vector) |
| Mảng 3 — SSRF/OS-cmd | ⚠️ 1,640 dòng: 1,153 trong `normal`, 487 gán nhầm `boolean_blind` |
