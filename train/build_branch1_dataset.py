"""Build data/processed/branch1_train.csv — the balanced Branch-1 dataset.
...
reports/branch1_architecture_comparison.json) - a sign the 363 templated
...
def main() -> None:
    ...
    out_path = processed_dir / "branch1_train.csv"
    fieldnames = [
        "id",
        "query_raw",
        "query_canonical",
